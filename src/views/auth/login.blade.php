...
<html
  ...
  <head>
    ...
    <!-- Vendor -->
    <link rel="stylesheet" href="{{url('tokalink-assets')}}/vendor/libs/@form-validation/umd/styles/index.min.css" />

    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{url('tokalink-assets')}}/vendor/css/pages/page-auth.css" />
  ...
  <body>
    ...
    <!-- Vendors JS -->
    <script src="{{url('tokalink-assets')}}/vendor/libs/@form-validation/umd/bundle/popular.min.js"></script>
    <script src="{{url('tokalink-assets')}}/vendor/libs/@form-validation/umd/plugin-bootstrap5/index.min.js"></script>
    <script src="{{url('tokalink-assets')}}/vendor/libs/@form-validation/umd/plugin-auto-focus/index.min.js"></script>

    <!-- Main JS -->
    <script src="{{url('tokalink-assets')}}/js/main.js"></script>

    <!-- Page JS -->
    <script src="{{url('tokalink-assets')}}/js/pages-auth.js"></script>
  </body>
</html>
