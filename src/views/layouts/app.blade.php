...
<html
  ...
  data-assets-path="{{url('tokalink-assets')}}/"
  ...
  <head>
    ...
    <script src="{{url('tokalink-assets')}}/vendor/js/template-customizer.js"></script>
                      ...
                      <ul class="list-group list-group-flush">
                        <li class="list-group-item list-group-item-action dropdown-notifications-item">
                          <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                              <div class="avatar">
                                <img src="{{url('tokalink-assets')}}/img/avatars/1.png" alt class="h-auto rounded-circle" />
                              </div>
                            </div>
                        ...
                        <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                          <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                              <div class="avatar">
                                <img src="{{url('tokalink-assets')}}/img/avatars/2.png" alt class="h-auto rounded-circle" />
                              </div>
                            </div>
                            <div class="flex-grow-1">
                        ...
                        <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                          <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                              <div class="avatar">
                                <img src="{{url('tokalink-assets')}}/img/avatars/9.png" alt class="h-auto rounded-circle" />
                              </div>
                            </div>
                            <div class="flex-grow-1">
                        ...
                        <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                          <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                              <div class="avatar">
                                <img src="{{url('tokalink-assets')}}/img/avatars/5.png" alt class="h-auto rounded-circle" />
                              </div>
                            </div>
                            <div class="flex-grow-1">
                        ...
                        <li class="list-group-item list-group-item-action dropdown-notifications-item">
                          <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                              <div class="avatar">
                                <img src="{{url('tokalink-assets')}}/img/avatars/6.png" alt class="h-auto rounded-circle" />
                              </div>
                            </div>
                            <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-end row">
                      ...
                      <div class="col-5 text-center text-sm-left">
                        <div class="card-body pb-0 px-0 px-md-4">
                          <img
                            src="{{url('tokalink-assets')}}/img/illustrations/card-advance-sale.png"
                            height="140"
                            alt="view sales" />
                        </div>
                      </div>
                    ...
                    <div class="card-body">
                      <ul class="p-0 m-0">
                        ...
                        <li class="d-flex mb-4 pb-1">
                          <div class="me-3">
                            <img
                              src="{{url('tokalink-assets')}}/img/products/nike-air-jordan.png"
                              alt="User"
                              class="rounded"
                              width="46" />
                          </div>
                        ...
                        <li class="d-flex mb-4 pb-1">
                          <div class="me-3">
                            <img
                              src="{{url('tokalink-assets')}}/img/products/apple-watch.png"
                              alt="User"
                              class="rounded"
                              width="46" />
                          </div>
                        ...
                        <li class="d-flex mb-4 pb-1">
                          <div class="me-3">
                            <img
                              src="{{url('tokalink-assets')}}/img/products/amazon-echo.png"
                              alt="User"
                              class="rounded"
                              width="46" />
                          </div>
                        ...
                        <li class="d-flex">
                          <div class="me-3">
                            <img
                              src="{{url('tokalink-assets')}}/img/products/play-station.png"
                              alt="User"
                              class="rounded"
                              width="46" />
                          </div>
