...
<head>
    ...
    <title>{{ env('APP_NAME', 'Tokalink') }}</title>
    ...
    <div class="wrapper">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="/assets-admin/theme3/dist/img/user1-128x128.jpg" alt="User Avatar"
                        ...
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="/assets-admin/theme3/dist/img/user8-128x128.jpg" alt="User Avatar"
                        ...
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="/assets-admin/theme3/dist/img/user3-128x128.jpg" alt="User Avatar"
                                    class="img-size-50 img-circle mr-3">
                                <div class="media-body">
                                    <h3 class="dropdown-item-title">
                                        Nora Silvester
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="../../index3.html" class="brand-link">
                <img src="/assets-admin/theme3/dist/img/AdminLTELogo.png" alt="AdminLTE Logo"
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="/assets-admin/theme3/dist/img/user2-160x160.jpg" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            <a href="/{{ tokalink::getAdminPrefix() }}" class="nav-link">
                        ...
                        @foreach (config('tokalink.menu') as $key => $menu)
                                ...
                                <li class="nav-item has-treeview">
                                    ...
                                    <ul class="nav nav-treeview">
                                        @foreach ($menu['child'] as $key2 => $menu2)
                                            <li class="nav-item">
                                                <a href="/{{ tokalink::getAdminPrefix() }}/{{ $menu2['route'] }}"
                                                    class="nav-link">
                            ...
                            @else
                                <li class="nav-item">
                                    <a href="/{{ tokalink::getAdminPrefix() }}/{{ $menu['route'] }}"
                                        class="nav-link">
                                        <i class="nav-icon {{ $menu['icon'] }}"></i>
                                        <p>
                                            {{ $key }}
                        ...
                        <li class="nav-item">
                            <a href="/{{ tokalink::getAdminPrefix() }}/users" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="/{{ tokalink::getAdminPrefix() }}/roles" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="/{{ tokalink::getAdminPrefix() }}/permission" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="/{{ tokalink::getAdminPrefix() }}/settings" class="nav-link">
                                <i class="nav-icon fas fa-columns"></i>
                                <p>
                                    Setting
                                </p>
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>
                                ...
                                <a href="?" id="btn_show_data" class="btn btn-sm btn-primary"
                                    title="Show Data">
                                    <i class="fa fa-table"></i> Show Data
                                </a>
                                <a href="{{ strtolower($table ?? 'Data') }}/add" id="btn_add_new_data"
                                    class="btn btn-sm btn-success" title="Add Data">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a
                                        href="{{ url(config('tokalink.admin_prefix')) }}">Home</a></li>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; {{ Date('Y') }} <a href="https://tokalink.id">TOKALINK</a>.</strong> All
            rights reserved.
        </footer>
